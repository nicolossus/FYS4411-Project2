...
class AiRBM:
    ...
    def __init__(self, nparticles, dim, hard_shell_diameter=0.00433, sigma2=1.):
        self._N = nparticles
        self._d = dim
    ...
    def potential(self, r):
        ...
        f = 1 - self._a / distances * (distances > self._a)
    ...
    def grad_v_bias(self, r, v_bias, h_bias, kernel):
        ...
        print("Shape grad v_bias ", gr.shape)
        return gr.sum()
    ...
    def grad_h_bias(self, r, v_bias, h_bias, kernel):
        ...
        print("Shape grad h_bias: ", gr.shape)
        return gr.sum()
    ...
    def grad_kernel(self, r, v_bias, h_bias, kernel):
        ...
        print("Shape grad kernel: ", gr.shape)
        return gr.sum()
