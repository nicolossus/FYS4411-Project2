...
def DerivativeWFansatz(NumberHidden, r, a, b, w):
    ...
    # For |psi|^2
    WfDer_a = 0.5 * (r - a)
    WfDer_b = 0.5     / denominator
    WfDer_w = 0.5 * w / denominator
...
def run_simulation(eta, MaxIterations, NumberMCcycles, interaction=True):
    ...
    outputfile = open("interactions2_" + str(eta) + "_" + str(MaxIterations) + ".txt", "w")
    ...
    np.savetxt("energies2_" + str(eta) + "_" + str(MaxIterations) + ".txt", Energies)
    outputfile.close()
